...
$tpl = <<<EOT
                    <div class="causes-item">
                        ...
                        <div class="causes-btn">
                            <a class="btn btn-custom" href="https://app.thegivehub.com/campaign.html?id=%%id%%">Saber Más</a>
                            <a class="btn btn-custom" hfre="https://app.thegivehub.com/donatenow.html?id=%%id%%">Donar Ahora</a>
                        </div>
                    </div>
EOT;
        ...
        <div class="causes">
            <div class="container">
                <div class="section-header text-center">
                    <p>Causas Populares</p>
                    <h2>Aquí están algunas de las campañas benéficas más populares en The Give Hub.</h2>
                </div>
